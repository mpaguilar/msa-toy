...
def test_controller_full_integration():
    ...
    with patch('msa.controller.components.WorkingMemoryManager') as mock_memory_manager, \
        ...
        mock_synthesis_engine_instance.synthesize_answer.return_value = mock_synthesis_result
...
def test_component_initialization():
    ...
    with patch('msa.controller.components.WebSearchTool') as mock_web_search, \
