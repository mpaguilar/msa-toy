...
from msa.evaluation.accuracy import evaluate_answer_accuracy, _extract_key_facts, _calculate_facts_coverage
from msa.evaluation.completeness import assess_completeness, _calculate_topic_coverage, _calculate_source_diversity
...
class TestAccuracyEvaluation:
    ...
    def test_evaluate_answer_accuracy_partial_match(self):
        ...
        predicted = "Python is a high-level programming language created by Guido van Rossum."
    ...
    def test_calculate_facts_coverage_exact_match(self):
        ...
        predicted_facts = ["Python is a programming language", "It was created by Guido"]
        ground_truth_facts = ["Python is a programming language", "It was created by Guido"]
    ...
    def test_calculate_facts_coverage_partial_match(self):
        ...
        predicted_facts = ["Python is a high-level programming language", "Created by Guido van Rossum"]
