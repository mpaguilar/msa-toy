...
def test_process_query_with_completion():
    ...
    with patch('msa.controller.components.initialize_llm_clients') as mock_init_llm_clients, \
         patch('msa.controller.components.initialize_tools') as mock_init_tools, \
         patch('msa.controller.components.create_prompt_templates') as mock_create_prompts, \
         patch('msa.controller.components.process_thoughts') as mock_process_thoughts, \
         patch('msa.controller.components.process_action_selection') as mock_process_action, \
         patch('msa.controller.components.process_completion_decision') as mock_process_completion, \
         patch('msa.controller.components.handle_tool_execution') as mock_handle_tool, \
         patch('msa.controller.observation_handler.process_observation') as mock_process_observation:
        ...
        mock_process_thoughts.return_value = "I need to search for information about the test query"
        ...
        mock_process_observation.return_value = "Processed: Search results for test query"
        ...
        mock_synthesis_engine.synthesize_answer.return_value = "Final synthesized answer"
...
def test_process_query_with_max_iterations():
    ...
    with patch('msa.llm.client.get_llm_client') as mock_get_llm_client, \
         patch('msa.controller.components.initialize_llm_clients') as mock_init_llm_clients, \
         patch('msa.controller.components.initialize_tools') as mock_init_tools, \
         patch('msa.controller.components.create_prompt_templates') as mock_create_prompts, \
         patch('msa.controller.components.process_thoughts') as mock_process_thoughts, \
         patch('msa.controller.action_handler.process_action_selection') as mock_process_action_selection, \
         patch('msa.controller.components.process_completion_decision') as mock_process_completion_decision, \
         patch('msa.controller.observation_handler.process_observation') as mock_process_observation:
