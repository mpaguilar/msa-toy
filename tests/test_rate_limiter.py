...
def test_rate_limiting():
    ...
    config = RateLimitConfig(requests_per_second=0.0, bucket_capacity=1)  # No refill rate
    limiter = RateLimiter(config)
...
def test_usage_stats():
    ...
    assert result2 is True  # Second request should also succeed with higher bucket capacity
