...
from msa.memory.models import WorkingMemory, InformationStore, Fact, QueryState, ExecutionHistory, ReasoningState, QueryRefinement
...
def test_synthesize_answer(sample_memory):
    ...
    with patch.object(engine.confidence_scorer, 'generate_confidence_report', return_value="Confidence: High"):
        result = engine.synthesize_answer(sample_memory, "How many state senators does Texas have?")
