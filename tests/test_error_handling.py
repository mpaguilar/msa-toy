...
class TestMemoryPersistence:
    ...
    def test_memory_state_preservation(self):
        ...
        assert (
            deserialized_memory.reasoning_state.current_hypothesis == "Test hypothesis"
        )
...
class TestCircuitBreakerIntegration:
    ...
    def test_circuit_breaker_trip_and_reset(self):
        ...
        config = CircuitBreakerConfig(
            failure_threshold=5, timeout_seconds=1, half_open_attempts=5,
        )
    ...
    def test_circuit_breaker_success_recovery(self):
        ...
        config = CircuitBreakerConfig(
            failure_threshold=2, timeout_seconds=1, half_open_attempts=2,
        )
